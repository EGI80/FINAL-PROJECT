...
<body style="font-family: Arial, sans-serif; background: #f4f4f9; margin: 0; padding: 20px;">
    ...
    <h2 style="text-align: center; color: #555;">Edit project</h2>

    <div style="text-align: center; margin-bottom: 20px;">
        <a href="{{ route('project.create') }}" style="background-color: #337ab7; color: #ffffff; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer; text-decoration: none; display: inline-block;">Buat project</a>
            ...
            <tbody>
                ...
                <tr style="background-color: #f9f9f9;">
                    <td style="width: 150px; padding: 10px;">
                        <img src="{{ asset('storage/project/'.$project->image) }}" height="100" style="border-radius: 10px; width: 100%; object-fit: cover;">
                    </td>
                    <td style="width: 300px; padding: 10px;">{{ $project->judul }}</td>
                    <td style="width: 300px; padding: 10px;">{{ $project->subjudul }}</td>
                    <td style="width: 150px; text-align: center; padding: 10px;">
                        <a href="{{ route('project.edit', $project->id) }}" class="btn btn-warning" style="background-color: #ffc107; color: #ffffff; padding: 5px 10px; border: none; border-radius: 5px; cursor: pointer; text-decoration: none;">Edit</a>
                        <form action="{{ route('project.destroy', $project->id) }}" method="POST" class="d-inline" style="display: inline;">
                            @csrf
                            @method('POST')
