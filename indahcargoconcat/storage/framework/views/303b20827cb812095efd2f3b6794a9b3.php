...
<body>
    ...
    <h1 style="text-align: center;">Halaman Dashboard Admin Idah logistik</h1>
    <h2 style="text-align: center;">Edit Hero</h2>
    ...
    <form action="<?php echo e(route('hero.update', $hero->id)); ?>" method="POST" enctype="multipart/form-data" style="max-width: 500px; margin: 40px auto; padding: 20px; background-color: #f9f9f9; border: 1px solid #ddd; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="judul" value="<?php echo e(old('judul', $hero->judul)); ?>" style="width: 100%; height: 40px; padding: 10px; font-size: 16px; border: 1px solid #ccc; border-radius: 5px;">
...
unset($__errorArgs, $__bag); ?>" name="subjudul" value="<?php echo e(old('subjudul', $hero->subjudul)); ?>" style="width: 100%; height: 40px; padding: 10px; font-size: 16px; border: 1px solid #ccc; border-radius: 5px;">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mb-4">
            ...
            <input type="hidden" name="old_image" value="<?php echo e($hero->image); ?>">
...
</html><?php /**PATH D:\ProjectEgi\indahcargoconcat\resources\views/admin/hero/edit.blade.php ENDPATH**/ ?>