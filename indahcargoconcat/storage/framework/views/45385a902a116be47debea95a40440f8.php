...
<body id="home">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 15px; padding: 50px;">
        <div style="background-color: #fff; border: 1px solid rgba(0,0,0,0.1); box-shadow: 0 4px 8px rgba(0,0,0,0.1); border-radius: 1rem; overflow: hidden;">
            <img src="<?php echo e(asset('assets/images/logologo.jpeg')); ?>" style="width: 100%; height: 200px; object-fit: cover;" alt="">
            <div style="padding: 1.25rem;">
                ...
                <a href="<?php echo e(route('hero')); ?>" style="background-color: #007bff; color: white; padding: 0.5rem 1rem; border: none; border-radius: 0.25rem; text-decoration: none; display: inline-block;">Detail</a>
            </div>
        </div>
        ...
        <div style="background-color: #fff; border: 1px solid rgba(0,0,0,0.1); box-shadow: 0 4px 8px rgba(0,0,0,0.1); border-radius: 1rem; overflow: hidden;">
            ...
            <div style="padding: 1.25rem;">
                ...
                <a href="<?php echo e(route('about')); ?>" style="background-color: #007bff; color: white; padding: 0.5rem 1rem; border: none; border-radius: 0.25rem; text-decoration: none; display: inline-block;">Detail</a>
            </div>
        </div>
...
</html><?php /**PATH D:\ProjectEgi\indahcargoconcat\resources\views/admin/index.blade.php ENDPATH**/ ?>