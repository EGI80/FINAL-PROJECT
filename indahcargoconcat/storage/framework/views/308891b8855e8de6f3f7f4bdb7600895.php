...
<body style="font-family: Arial, sans-serif; background: #f4f4f9; margin: 0; padding: 20px;">
    ...
    <div style="text-align: center; margin-bottom: 20px;">
        <a href="<?php echo e(route('hero.create')); ?>" style="background-color: #337ab7; color: #ffffff; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer; text-decoration: none; display: inline-block;">Buat hero</a>
            ...
            <tbody>
                ...
                <tr style="background-color: #f9f9f9;">
                    <td style="width: 150px; padding: 10px;">
                        <img src="<?php echo e(asset('storage/hero/'.$hero->image)); ?>" height="100" style="border-radius: 10px; width: 100%; object-fit: cover;">
                    </td>
                    <td style="width: 300px; padding: 10px;"><?php echo e($hero->judul); ?></td>
                    <td style="width: 300px; padding: 10px;"><?php echo e($hero->subjudul); ?></td>
                    <td style="width: 150px; text-align: center; padding: 10px;">
                        <a href="<?php echo e(route('hero.edit', $hero->id)); ?>" class="btn btn-warning" style="background-color: #ffc107; color: #ffffff; padding: 5px 10px; border: none; border-radius: 5px; cursor: pointer; text-decoration: none;">Edit</a>
                        <form action="<?php echo e(route('hero.destroy', $hero->id)); ?>" method="POST" class="d-inline" style="display: inline;">
                            <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\ProjectEgi\indahcargoconcat\resources\views/admin/hero/index.blade.php ENDPATH**/ ?>