...
<body>
    ...
    <form action="<?php echo e(route('about.update', $about->id)); ?>" method="POST" enctype="multipart/form-data" style="max-width: 500px; margin: 40px auto; padding: 20px; background-color: #f9f9f9; border: 1px solid #ddd; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="judul" value="<?php echo e(old('judul', $about->judul)); ?>" style="width: 100%; height: 40px; padding: 10px; font-size: 16px; border: 1px solid #ccc; border-radius: 5px;">
...
</html><?php /**PATH D:\ProjectEgi\indahcargoconcat\resources\views/admin/about/edit.blade.php ENDPATH**/ ?>